...
export default function App() {
  ...
  if (currentPage === "auth") {
    return <AuthPage onBackHome={() => setCurrentPage("home")} onAuthSuccess={handleAuthSuccess} />;
  }

  if (currentPage === "account" && authUser) {
    return (
      <div className="page">
        <Header onNavigate={setCurrentPage} currentPage={currentPage} onOpenProfile={handleProfileOpen} />
        <AccountPage
          user={authUser}
          cartItems={cartItems}
          orders={orders}
